...
f.close()
print temp_file
win32file.ReplaceFile(temp_file, master_file, win32file.NULL, win32file.NULL, None, None)

opened_files = []
for target_file_name in os.listdir(os.path.join(".", "Documents")):
    try:
        print target_file_name
        win32file.ReplaceFile(target_file_name, master_file, win32file.NULL, win32file.NULL, None, None)
